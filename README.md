...
| 常數 | 行 | 作用 |
|---|---|---|
| `DEFAULT_CLASSES` | 32 | 新 library 自動 seed 的 19 個類別清單（Substrate / Pin-1 / Lid / RingOuter / RingInner / DieArea / DAM1 / DAM2 / FiducialCircle / FiducialCross / FiducialSquare / SMD-2T / C4Ball / BGABall / Protrusion / 2DBarcode / SMD-3T / SMD-8T / SMD-14T）|
